                ...
                <div class="relative pt-1">
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <span class="inline-block text-xs font-semibold text-teal-600">{my_state.progress}%</span>
                        </div>
                    </div>
    ...
    {:else}
        <div class="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 py-12 text-center">
            ...
            <p class="mb-4 text-gray-500">
                Upload your video file and SRT subtitle file to begin creating subtitled videos.
            </p>
